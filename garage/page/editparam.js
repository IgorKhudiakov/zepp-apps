...
Page(
  BasePage({
    ...
    onInit(data) {
      ...
      let startY = isRoundedScreen ? 50 : 10

      hmUI.createWidget(hmUI.widget.TEXT, {
        x: isRoundedScreen ? 50 : 10,
        y: startY,
        w: screenWidth - (isRoundedScreen ? 100 : 20),
        h: 30,
        text: data.text,
        text_size: 20,
      ...
      createButtons({ UI: hmUI, y: keyboard.Y + keyboard.H + 10, buttons: { 1: { name: 'back', type: 'replace', url: 'page/index' } } })
    },
    build() { },
    onDestroy() { },
  })
